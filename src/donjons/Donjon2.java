...
public class Donjon2 extends Donjons {
    ...
    public Donjon2(ArrayList<Personnages> personnages) {
        super("Donjon par défaut 2", 25, 25, 0);
        setDesc("Deuxième donjon par défaut");
        ...
        posJoueurs.add(new Positions(22, 3));
        posJoueurs.add(new Positions(22, 4));
        posJoueurs.add(new Positions(22, 5));
        posJoueurs.add(new Positions(22, 6));
        posJoueurs.add(new Positions(22, 7));
        posJoueurs.add(new Positions(23, 3));
        posJoueurs.add(new Positions(23, 4));
        posJoueurs.add(new Positions(23, 5));
        posJoueurs.add(new Positions(23, 6));
        posJoueurs.add(new Positions(23, 7));
